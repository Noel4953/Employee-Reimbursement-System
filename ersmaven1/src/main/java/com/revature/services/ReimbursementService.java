...
//        return reimbursemntDao.process(unprocessedReimbursement);
//   }
    ...
    public Reimbursement create(Reimbursement reimbursementToBeCreated) {
    		return reimbursemntDao.create(reimbursementToBeCreated); 
    }
    ...
    public List<Reimbursement> getReimbursementsByStatus(Status status) {
        return reimbursemntDao.getByStatus(status);
    }
